...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden w-full bg-gray-900 text-white">
      ...
      {/* Section Héro avec Vidéo - Responsive Improvements */}
      <section className="relative min-h-[100vh] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center py-20 md:py-0">
          <div className="md:mt-40 md:max-w-3xl ">
            <motion.h1
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-8 sm:mb-6 text-cyan-400  mt-10t sm:mt-8"
            ...
            <motion.p
              className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 max-w-full"
              initial={fadeIn.initial}
              animate={fadeIn.animate}
              transition={{ ...fadeIn.transition, delay: 0.2 }}
            >
              Connectez-vous avec les meilleurs chercheurs en sécurité <br className="hidden sm:block" />et protégez vos applications.
            </motion.p>
            <motion.div
            ...
            >
              <Button size="lg" className="bg-cyan-500 hover:bg-cyan-800 w-full sm:w-auto" asChild>
                <Link to="/entreprise/register" className="flex items-center justify-center">
                  <Building2 className="mr-2 h-5 w-5" />
                  <span className="whitespace-nowrap">Rejoindre en tant qu'Entreprise</span>
                </Link>
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="border-white text-black hover:text-white hover:bg-cyan-400/5 w-full sm:w-auto"
                asChild
              >
                <Link to="/hacker/register" className="flex items-center justify-center">
                  <Bug className="mr-2 h-5 w-5" />
                  <span className="whitespace-nowrap">Rejoindre en tant que Hacker</span>
                </Link>
              </Button>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-gray-700">
        <div className="max-w-7xl mx-auto px-4 w-full">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-12">
            ...
            <Button variant="outline" className="mt-4 sm:mt-0 text-black hover:text-white hover:bg-cyan-400/5" asChild>
