    ...
    <AuthContainer title="Inscription Hacker">
      ...
      <form onSubmit={handleSubmit(onRegisterSubmit)} className="space-y-6">
        ...
        >
          ...
          <Button type="button" className="w-full  text-blue-600 hover:text-blue-800 " variant="link" onClick={() => navigate('/hacker/login')}>
    ...
    <AuthContainer title="Connexion Hacker">
      ...
      <form onSubmit={handleSubmit(onLoginSubmit)} className="space-y-6">
        ...
        >
          ...
          <Button type="button" className="w-full    text-blue-600 hover:text-blue-800 " variant="link" onClick={() => navigate('/hacker/register')}>
      ...
      <div className="relative z-10 max-w-md w-full space-y-6 overflow-hidden">
        ...
        >
          ...
          >
            ...
            >
              <Bug className="w-10 h-10 mx-auto text-blue-600 mb-4" />
            </motion.div>
