  ...
  return (
    <div className="min-h-screen bg-[#141d2b] text-gray-100">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 bg-[#1a2332] border-[#2a3655] text-gray-100 placeholder-gray-500 focus:border-cyan-600 focus:ring-cyan-700"
                value={searchTerm}
              ...
              {allScopes.map(scope => (
                <Button
                  ...
                  className={selectedScope.includes(scope) 
                    ? 'bg-cyan-500 hover:bg-cyan-500 text-black border-none'
      ...
      <Button
        variant="default"
        size="icon"
        className="fixed bottom-4 right-4 rounded-full w-12 h-12 shadow-lg bg-cyan-500 hover:bg-cyan-500 text-black"
      >
