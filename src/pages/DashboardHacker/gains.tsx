...
import { Search, ArrowUpRight, TrendingUp, Bell, Settings, LogOut } from 'lucide-react';
          ...
          <div className="bg-[#1a2332] rounded-lg shadow-xl p-6 mb-8 border border-[#2a3655]">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-3xl font-bold text-[#9fef00]">{totalEarnings.toLocaleString()} ₣</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2 text-gray-400">Programmes Totaux</h3>
                <p className="text-3xl font-bold text-gray-100">{mockEarnings.length}</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2 text-gray-400">Taux de Réussite</h3>
                <p className="text-3xl font-bold text-[#9fef00]">
                  {Math.round(
              ...
              <div className="p-6">
                ...
                {selectedProgram === earning.id && (
                  ...
                  >
                    ...
                    <div className="mt-4">
                      <Button 
                        className="bg-[#9fef00] hover:bg-[#8bdf00] text-black border-none"
                        asChild
                      >
