                    ...
                    {showAvatarSelector && (
                      <div className="flex gap-4 mt-4">
                        {predefinedAvatars.map((avatarUrl, index) => (
                          <Avatar 
                            key={index}
                            className="h-12 w-12 cursor-pointer hover:ring-2 hover:ring-cyan-500 border border-[#2a3655]"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input 
                      type="text" 
                      placeholder="Pseudo" 
                      className="bg-[#2a3655] border-[#374873] text-gray-100 placeholder-gray-500 focus:border-cyan-500 focus:ring-cyan-800"
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <Input 
                      ...
                      className="bg-[#2a3655] border-[#374873] text-gray-100 placeholder-gray-500 focus:border-cyan-500 focus:ring-cyan-800"
                    />
                    <Button className="bg-cyan-500 hover:bg-cyan-800 text-black border-none">
